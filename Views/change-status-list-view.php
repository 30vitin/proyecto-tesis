                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-actions">
                                                        <a href="#"
                                                           ...
                                                           data-original-title="Cambiar status"
                                                           data-action="PURCHASE-REQUEST-SET-STATUS"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="td-actions">
                                                        <a href="#"
                                                           ...
                                                           class="btn btn-primary btn-link btn-sm set-status-document"
                                                           data-original-title="Cambiar status"
                                                           data-action="PURCHASE-ORDER-SET-STATUS"
                                                           data-id="<?php echo $item->id; ?>">
                                                            <i class="material-icons">edit</i>
                                                            <div class="ripple-container"></div>
                                                        </a>
