...
<head>
    ...
    <title>
        Crear Despacho de Mercancía | Cafeteria
    </title>
                    ...
                    <div class="col-md-12">
                        <div class="card ">
                            <div class="card-header card-header-warning card-header-text">
                                <div class="card-text">
                                    <h4 class="card-title">Crear Nueva Despacho de Mercancía </h4>
                                </div>
                            </div>
                            <div class="card-body ">
                                ...
                                <div class="row">
                                    <div class="col-md-12 ">
                                        <button type="button" class="btn btn-primary pull-right btn-send-form-table"
                                                data-form="form" data-reset="true"> Guardar Despacho de Mercancía
                                        </button>
                                ...
                                <form class="form-horizontal" id="form" onkeydown="return event.key != 'Enter';"
                                    ...
                                    <input type="hidden" name="a" value="CREATE-DISPATCH-MERCHANT">
