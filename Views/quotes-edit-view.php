                                    ...
                                    <div class="row">
                                        <div class="col-md-12 ">
                                            <?php if ($response['status'] == 'ACTIVO') { ?>
                                                ...
                                                <button type="button" class="btn btn-success pull-right btn-confirm-action <?php echo $classDisable; ?>" data-id="<?php echo $id; ?>" data-action="APROVE-QUOTE" data-text="¿Estas seguro de aprobar esta cotización?" <?php echo $disabled; ?> data-validform="true" data-validtableform="true">
                                            ...
                                            <?php if ($response['status'] == 'APROBADA' || $response['status'] == 'CERRADO') { ?>
                                                ...
                                                <a href="./?view=pdf-generate&id=<?php echo $id; ?>&section=quotes" class="btn btn-secondary pull-right print" data-form="form" data-reset="true"> Imprimir
                                                </a>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group bmd-form-group">
                                                        ...
                                                        <?php } else { ?>
                                                            ...
                                                            ?>
                                                            <select class="form-control validate select2 change-and-consult-edit" name="order_id" id="order_id" data-action="GET-PURCHASE-ORDER-TO-QUOTE" data-form="form" <?php echo $disabled; ?>>
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group bmd-form-group">
                                                        <input type="number" class="form-control" name="days_expired" value="<?php echo $response['days_expired']; ?>" id="days_expired" placeholder="Dias de vencimiento">
                                            ...
                                            <div class="col-md-12 table-responsive">
                                                ...
                                                <table class="table ">
                                                    ...
                                                    <tbody class="table-data-edit disable-button" data-action="GET-QUOTES-DETAILS-TO-QUOTE" data-action-change="GET-ORDER-DETAILS-TO-QUOTE" data-id="<?php echo $id; ?>">
