...
class Functions extends dba
{
    ...
    public function generatePdfPurchaseOrder($id)
    {
        ...
        $sql1 = "SELECT t1.date,t1.reference,t1.purchase_request,t2.name as provider,t2.telephone1,t2.ruc as ruc,t2.dv FROM purchase_orders t1 JOIN providers t2 on t1.provider = t2.id WHERE t1.id='PO000027'";
        $maindata = $this->consulQuery($sql1);
